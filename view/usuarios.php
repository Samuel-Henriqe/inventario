...
<html lang="pt-BR">
    ...
    <head>
        ...
        <title>Usuários - Sistema de Inventário</title>
    ...
    <body>
        ...
        <!-- Header com navegação e título da página de usuários -->
        ...
        <div class="container mt-4">
            ...
            <div class="alert alert-info">
                ...
                <p>Esta funcionalidade está sendo desenvolvida. Em breve você poderá gerenciar os usuários do sistema.</p>
            </div>
        </div>
