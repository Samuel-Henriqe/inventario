...
<head>
    ...
    <title>Itens - Sistema de Inventário</title>
...
<body>
    ...
    <!-- Header com navegação e título da página de itens -->
    <header class="d-flex align-items-center justify-content-between px-3" style="height:var(--header-height);">
        ...
        <h1 class="mb-0">Gerenciar Itens</h1>
    ...
    <div class="container mt-4">
        ...
        <div class="alert alert-info">
            ...
            <p>Esta funcionalidade está sendo desenvolvida. Em breve você poderá gerenciar os itens do inventário.</p>
        </div>
    </div>
