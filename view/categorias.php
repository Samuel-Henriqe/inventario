...
<head>
    ...
    <title>Categorias - Sistema de Inventário</title>
...
<body>
    ...
    <!-- Header com navegação e título da página de categorias -->
    ...
    <div class="container mt-4">
        ...
        <div class="alert alert-info">
            ...
            <p>Esta funcionalidade está sendo desenvolvida. Em breve você poderá gerenciar as categorias dos itens.</p>
        </div>
    </div>
